  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="delsub.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-building"></i>
            </div>
            <span class="nav-link-text ms-1">Delete Subject</span>
          </a>
        </li>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h3 class="font-weight-bolder mb-0">See Subjects</h3>
        </nav>
                ...
                <table class="table align-items-center mb-0" border = 1 cellspacing = 0 cellpadding = 10>
                  ...
                  <tr>  
                    ...
                    <th  class="text-uppercase  text-xxs font-weight-bolder opacity-7">subject name</th>
                      ...
                      <th  class="text-uppercase  text-xxs font-weight-bolder opacity-7">Theory</th>
                      <th  class="text-uppercase  text-xxs font-weight-bolder opacity-7">practical</th>
                      <th  class="text-uppercase  text-xxs font-weight-bolder opacity-7">Department</th>
                  ...
                  <tr>
                    ...
                    <!-- sub code -->
                      ...
                      <td  class="text-uppercase "> 
                         <h6 class="mb-0 text-sm"> <?php echo $row["subcode"]; ?></h6>
                        </td>
                    ...
                    <!-- total hours -->
                      ...
                      <p class="text-xs font-weight-bold mb-0"><?php echo $row["tot_hours"]; ?></p> 
                      </td>
                    ...
                    <!--year -->
                      ...
                      <td  class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                      <p class="text-xs font-weight-bold mb-0"><?php echo $row["theory"]; ?></p> 
                      </td>


                      <!-- practical-->
                      <td  class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                      <p class="text-xs font-weight-bold mb-0"> <?php echo $row["practical"]; ?></p> 
                      </td>


                      <!-- department -->
                      <td  class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                      <p class="text-xs font-weight-bold mb-0"><?php echo $row["dnum"]; ?></p> 
                      </td>
