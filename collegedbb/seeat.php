...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h3 class="font-weight-bolder mb-0">Attendance</h3>
        </nav>
    ...
    $query = "SELECT * FROM attendance ORDER BY usnn";
    ...
    ?>
                ...
                <table class="table align-items-center mb-0" border = 1 cellspacing = 0 cellpadding = 10>
                  ...
                  <tr>                  
                    ...
                    <th  class="text-uppercase  text-xxs font-weight-bolder opacity-7">subcode</th>
                      ...
                      <th  class="text-uppercase  text-xxs font-weight-bolder opacity-7">attended</th>
                  ...
                  <tr>
                      ...
                      <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $row["usnn"]; ?></h6>
                    ...
                    <!-- Sub -->
                      ...
                      <td  class="text-uppercase "> 
                         <h6 class="mb-0 text-sm"> <?php echo $row["sub"]; ?></h6>
                        </td>
